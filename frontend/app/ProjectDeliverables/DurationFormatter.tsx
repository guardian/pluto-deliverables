...
const DurationFormatter:React.FC<DurationFormatterProps> = (props) => {
    ...
    useEffect(()=>{
        ...
        const seconds = Math.floor (props.durationSeconds - (hours*3600) - (mins*60));

        const finalString = `${hours.toString().padStart(2,"0")}:${mins.toString().padStart(2,"0")}:${seconds.toString().padStart(2,"0")}`;
