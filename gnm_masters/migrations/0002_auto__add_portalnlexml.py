...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PortalNleXml'
        db.create_table('gnm_masters_portalnlexml', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=61)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('gnm_masters', ['PortalNleXml'])


    def backwards(self, orm):
        # Deleting model 'PortalNleXml'
        db.delete_table('gnm_masters_portalnlexml')
